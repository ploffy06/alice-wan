export const bookReviewsData = [
    {
      ...
      author_firstname: "Joe",
      author_lastname: "Halderman",
      rating: 2.5,
      tags: ["fiction"],
      description: `
    ...
    },
    {
      ...
      author_firstname: "Yukio",
      author_lastname: "Mishima",
      rating: 4,
      tags: ["fiction"],
      description: `
    ...
    },
    {
      ...
      author_firstname: "Haruki",
      author_lastname: "Murakami",
      rating: 5,
      tags: ["fiction"],
      description: `
    ...
    },
    {
      ...
      author_firstname: "Ray",
      author_lastname: "Bradbury",
      rating: 3,
      tags: ["fiction"],
      description: `
    ...
    },
    {
      ...
      author_firstname: "Toshikazu",
      author_lastname: "Kawaguchi",
      rating: 3.5,
      tags: ["fiction"],
      description: `
      What would you do if you could momentarily travel back in time? This book presents
      complex relationships between characters with heartwarming motivations to travel back
      in time. It is a short, light, fast-paced story and I enjoyed it.
      `
    },
    {
      title: "The Memory Police",
      author_firstname: "Yoko",
      author_lastname: "Ogawa",
      rating: 3.5,
      tags: ["fiction"],
      description: `
      Very perculiar and eerie. This books can be either read as an Orwellian dystopia or an
    ...
    },
    {
      ...
      author_lastname: "Thiel",
      rating: 4,
      tags: ["non-fiction"],
      description: `
      An informative introduction on what it takes to successfully build a long-term startup. In this book, Thiel
      brings in many interesting case studies and his own experiences. In particular he gives seven questions
      that every business must answer as a strong guideline for beginners.
      `
    },
    {
      title: "The Three-Body Problem",
      author_firstname: "Cixin",
      author_lastname: "Liu",
      rating: 3.5,
      tags: ["fiction"],
      description: `
    ...
    },
    {
      ...
      author_firstname: "George R. R.",
      author_lastname: "Martin",
      rating: 5,
      tags: ["fiction"],
      description: `
      Very exciting. The book is much better than the series. I love seeing the politics and character motives unravel.
      My personal favourite is Tyrion, though who doesn't love him. I found the third person limited
      omniscient of different characters to be an interesting method of story-telling. Can't wait to read the
      rest of the series.
      `
    },
    {
      title: "The Gene: An Intimate History",
      author_firstname: "Siddhartha",
      author_lastname: "Mukherjee",
      rating: 4,
      tags: ["non-fiction"],
      description: `
      This is a detailed and engaging "history-lesson" of how we came to understand and apply our knowledge of the gene.
